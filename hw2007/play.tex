...
Another common operation covered by many boilerplate removal systems is the traversal. We model our traversals as rewrite rules.
...
The thing to note about this example is that each rule corresponds to the natural Haskell translation of the rule. The |traverse| function manages all the required 
