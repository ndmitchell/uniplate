...
repChildren x = (children_, context)
    where
        children_ = concat $ gmapQ (fst . replaceType) x

        context xs = evalState (gmapM f x) xs
        f y = do  let (cs,con) = replaceType y
...
\hspace{\maxfirst} & \makebox[\maxany][r]{simp} & \makebox[\maxany][r]{var} & \makebox[\maxany][r]{zero} & \makebox[\maxany][r]{const} & \makebox[\maxany][r]{ren} & \makebox[\maxany][r]{syms} & \makebox[\maxany][r]{bill} & \makebox[\maxany][r]{incr} & \makebox[\maxany][r]{incr1} & \textbf{Queries} & \textbf{Traversals} & \makebox[\maxany][r]{\textbf{All}} \\
