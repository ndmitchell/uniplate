...
The |Expr| type represents a small language for integer expressions, which permits free variables. Suppose we need to extract a list of all the variables in an expression:
...
The Uniplate library provides a single method to support queries, the |universe| function.
...
\begin{code}
setChildren x ns = fst (dExpr x ns)
